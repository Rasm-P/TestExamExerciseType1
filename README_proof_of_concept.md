...
- Create two local databases (on your vagrant image) named exactly (exactly is only for this proof of concept) as below:
  - `TestExamExerciseType1`
  - `TestExamExerciseType1_test`
- Create a REMOTE database on your Droplet named exacly like this: `TestExamExerciseType1`
...
`export CONNECTION_STR="jdbc:mysql://localhost:3306/TestExamExerciseType1"
`
